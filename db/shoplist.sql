...
CREATE TABLE IF NOT EXISTS festasbv.shoplist (
  ...
  quantidade   text    NOT NULL DEFAULT '',      -- só a quantidade (ex.: "4", "2 kg")
  tamanho      text,                             -- tamanho/embalagem (ex.: "lata 250 ml"); UI mostra "4 × lata 250 ml"
...
-- 2026-07: tamanho/embalagem separado da quantidade (instalações anteriores

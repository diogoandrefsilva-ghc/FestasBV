...
--   membros (proporcional ao `m.V` de cada um) e a sobra fica em 200 €.
--
...
COMMENT ON COLUMN festasbv.eventos.teto_reserva IS
  'Teto da sobra do grupo (saldoGrupo) DESTE evento. O que passar daqui é devolvido aos membros, proporcional ao que cada um paga. NULL = sem teto (o comportamento de sempre); 0 = teto a sério, não guardar nada.';

...
- **A despensa 🫙 não tem bloco à parte aqui** (ao contrário do ecrã): cai na categoria dela — o azeite é mercearia, não uma secção "despensa". O que a marca continua a valer é o que interessa a quem compra: **uma linha só e a quantidade pelo máximo**, com o 🫙 no nome a dizer porquê.

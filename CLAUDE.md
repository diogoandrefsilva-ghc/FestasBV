...
- **A ação é do grupo** (`claimGrupo`/`unclaimGrupo`/`toggleCartGrupo`): reclamar/largar o artigo inteiro de uma vez, que é como se compra — o vinho dos dois jantares traz-se numa ida. Não passam pelo `claimSameElsewhere` (esse pergunta "levas também?"; aqui a resposta foi dada no toque). **Cada pedido continua uma linha independente na BD** — o que a compra vai colmatar decide-se depois, ao registá-la (o picker dos pedidos e o 🔗 de cada artigo).
